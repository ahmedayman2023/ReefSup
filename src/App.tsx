      ...
      if (navigator.share && navigator.canShare) {
        ...
        if (navigator.canShare({ files })) {
          await navigator.share({
            ...
            text: `تمت مشاركة ${selectedPhotos.length} صورة من تطبيق ReefSupV1.3`,
          });
          return;
        }
      }
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          <h1 className="text-4xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-white to-white/40">ReefSupV1.3</h1>
    ...
    return (
      <div className="min-h-[100dvh] bg-black text-white flex flex-col items-center justify-center font-sans relative overflow-hidden p-6">
        ...
        >
          ...
          <h1 className="text-4xl font-bold mb-4 tracking-tight drop-shadow-md">ReefSupV1.3</h1>
      ...
      <header className={`${view === 'camera' ? 'absolute' : 'relative bg-zinc-950 border-b border-white/5'} top-0 left-0 right-0 p-4 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent z-50`}>
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold tracking-tight drop-shadow-md">ReefSupV1.3</h1>
          </div>
